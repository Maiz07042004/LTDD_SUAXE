            ...
            public void onResponse(Call<List<CuaHang>> call, Response<List<CuaHang>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (cuaHangList != null) {
                        ...
                        Toast.makeText(CuaHang_Activity.this, "Không có dữ liệu cửa hàng", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(CuaHang_Activity.this, "Lỗi: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<CuaHang>> call, Throwable t) {
                Toast.makeText(CuaHang_Activity.this, "Lỗi kết nối: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void AnhXa(){
