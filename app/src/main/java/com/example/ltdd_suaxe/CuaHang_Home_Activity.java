...
public class CuaHang_Home_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuahang_home);

        mViewPageUser=findViewById(R.id.view_pager_home_cuahang);
        mBottomNavigationView=findViewById(R.id.bottom_navigation_cuahang);

        ViewPagerAdapterCuaHang mViewPagerAdapterCuaHang=new ViewPagerAdapterCuaHang(this);
        mViewPageUser.setAdapter(mViewPagerAdapterCuaHang);
